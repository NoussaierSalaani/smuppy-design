...
<main class="p1-main">
  <div class="p1-pro-hero">
    {smuppy_icon(80, 'gradient' if th['html']=='dark' else 'dark')}
    <h1 class="p1-pro-title">Smuppy Premium</h1>
    <p class="p1-pro-sub">Abonnement mensuel · selon ton type de compte</p>
  </div>

  <div class="p1-plans">
    <div class="p1-plan p1-plan-active" style="grid-column:1 / -1">
      <div class="p1-plan-header"><span class="p1-plan-badge">TON COMPTE · PRO CREATOR</span></div>
...
def screen_session_ended(th: dict) -> str:
  ...
  <div class="p2-rate-actions">
    <button class="cta-primary p2-smups-cta"><span class="p2-smups-emoji">👊</span> Envoyer des Smups à Sara</button>
    <button class="cta-ghost">Réserver à nouveau</button>
    <button class="auth-link-row">Terminé</button>
  </div>
</div>'''


def screen_live_ended(th: dict) -> str:
    """Fin d'un LIVE (founder jun03 : l'écran fin de live n'existait pas). Récap + CTA Smups au créateur."""
    return f'''<div class="success-wrap">
  <div class="success-check">
    <div class="success-check-ring"></div>
    <ion-icon name="checkmark" class="success-check-icon"></ion-icon>
  </div>
  <h1 class="success-title">Live terminé !</h1>
  <p class="success-body">42 min avec Sara Khan · Yoga live</p>

  <div class="p2-stats-card">
    <div class="p2-stat"><div class="p2-stat-num">1.2k</div><div class="p2-stat-lbl">Spectateurs</div></div>
    <div class="p2-stat-divider"></div>
    <div class="p2-stat"><div class="p2-stat-num">42</div><div class="p2-stat-lbl">min</div></div>
    <div class="p2-stat-divider"></div>
    <div class="p2-stat"><div class="p2-stat-num">340</div><div class="p2-stat-lbl">👊 Smups</div></div>
  </div>

  <h3 class="p2-rate-title">Tu as kiffé ce live ?</h3>
  <div class="p2-rate-stars">
    <span class="p2-star p2-star-on">★</span><span class="p2-star p2-star-on">★</span>
    <span class="p2-star p2-star-on">★</span><span class="p2-star p2-star-on">★</span>
    <span class="p2-star p2-star-on">★</span>
  </div>
  ...
  <div class="p2-rate-actions">
    <button class="cta-primary p2-smups-cta"><span class="p2-smups-emoji">👊</span> Envoyer des Smups à Sara</button>
    <button class="cta-ghost">S&rsquo;abonner à la chaîne</button>
    <button class="auth-link-row">Fermer</button>
  </div>
</div>'''
...
<main class="p1-main">
  ...
  <div class="p2-svc-chosen">
    <span class="p1-row-ic" style="background:rgba(51,160,137,0.15);color:var(--mint)"><ion-icon name="barbell-outline" style="font-size:18px"></ion-icon></span>
...
SCREENS = {
    ...
    'p2_creator_booking_v2': ('Réserver une session', screen_book_session),
    ...
    'p2_live_ended_v2': ('Live ended', screen_live_ended),
...
<style>
  /* P2 wallet hero */
  .p2-wallet-hero { background:linear-gradient(135deg, rgba(51,160,137,0.2), rgba(0,179,199,.10));
    border:1.5px solid rgba(51,160,137,0.225); border-radius:24px; padding:20px;
    box-shadow:0 0 32px rgba(51,160,137,0.2); margin:0 0 14px; }
  ...
  .p2-wallet-divider { width:1px; height:32px; background:rgba(51,160,137,0.15); }
  ...
  .p2-smup-btn { flex:1; display:inline-flex; align-items:center; justify-content:center; gap:6px;
    ...
    background:var(--card); border:1.5px solid rgba(51,160,137,0.225);
  ...
  .p2-smup-btn-primary {
    ...
    box-shadow:0 4px 14px rgba(51,160,137,0.225) !important; }
  ...
  .p2-kyc-step-on { background:var(--card); color:var(--mint);
    border-color:rgba(51,160,137,0.225);
    box-shadow:0 0 10px rgba(51,160,137,0.2); }
  .p2-kyc-step-done { background:rgba(51,160,137,0.1); color:var(--mint);
    border-color:rgba(51,160,137,0.15); }
  ...
  .p2-kyc-card-on { border-color:rgba(51,160,137,0.225); background:rgba(51,160,137,0.06);
  ...
  .p2-kyc-photo-frame { aspect-ratio:5/3;
    background:var(--input-bg); border:2px dashed rgba(51,160,137,0.2);
  ...
  .p2-kyc-info { display:flex; align-items:flex-start; gap:10px;
    ...
    background:rgba(51,160,137,0.06); border:1px solid rgba(51,160,137,0.2);
    margin:0 0 14px; }
  ...
  .p2-sess-avatar { width:52px; height:52px; border-radius:14px; object-fit:cover;
    border:2px solid rgba(51,160,137,0.15);
    box-shadow:0 0 10px rgba(51,160,137,0.18); flex-shrink:0; }
  ...
  .p2-sess-join { padding:8px 14px; border-radius:999px;
    ...
    cursor:pointer; box-shadow:0 4px 12px rgba(51,160,137,0.2); }
  ...
  .p2-creator-card { display:flex; align-items:center; gap:12px;
    ...
    border-radius:18px;
    box-shadow:0 0 20px rgba(51,160,137,0.12); }
  ...
  .p2-dur-on { border-color:rgba(51,160,137,0.225); background:rgba(51,160,137,0.08);
    box-shadow:0 0 14px rgba(51,160,137,0.2); }
  ...
  .p2-day-on { border-color:rgba(51,160,137,0.225); background:rgba(51,160,137,0.1);
    box-shadow:0 0 12px rgba(51,160,137,0.25); }
  ...
  .p2-slot { padding:9px 4px; border-radius:11px;
    ...
    cursor:pointer; }
  .p2-slot-on { background:linear-gradient(135deg, rgba(51,160,137,0.16), rgba(0,179,199,.10));
    color:var(--mint); border-color:rgba(51,160,137,0.225);
    box-shadow:0 0 14px rgba(51,160,137,0.25); }
  ...
  .p2-book-summary { display:flex; align-items:center; gap:14px;
    ...
    background:var(--card); border:1.5px solid rgba(51,160,137,0.15);
    border-radius:18px; box-shadow:0 0 20px rgba(51,160,137,0.15); }
  ...
  .p2-pay-summary { display:flex; align-items:center; gap:12px;
    ...
    border:1.5px solid rgba(51,160,137,0.15); border-radius:18px;
    box-shadow:0 0 18px rgba(51,160,137,0.1); margin:0 0 14px; }
  ...
  .p2-pay-method { display:flex; align-items:center; gap:14px;
    ...
    background:var(--card); border:1.5px solid var(--input-border);
    cursor:pointer; font-family:inherit; }
  .p2-pay-method-on { border-color:rgba(51,160,137,0.225); background:rgba(51,160,137,0.06);
    box-shadow:0 0 14px rgba(51,160,137,0.2); }
  ...
  .p2-pay-method-tag { font-size:10px; font-weight:800; color:var(--mint);
    background:rgba(51,160,137,0.14); padding:3px 8px; border-radius:999px;
    flex:0 !important; }
  ...
  .p2-stats-card { display:flex; align-items:center; gap:14px;
    ...
    background:var(--card); border:1px solid rgba(51,160,137,0.2);
  ...
  .p2-smups-cta { display:flex; align-items:center; justify-content:center; gap:6px; }
  .p2-smups-emoji { font-size:18px; }
  ...
  .p2-svc-chosen { display:flex; align-items:center; gap:12px;
    padding:12px 14px; border-radius:14px;
    background:var(--card); border:1.5px solid rgba(51,160,137,0.175);
    box-shadow:0 0 16px rgba(51,160,137,0.15); margin:0 0 6px; }
  ...
  .p2-svc-change { padding:6px 12px; border-radius:999px;
    background:rgba(51,160,137,0.1); border:1px solid rgba(51,160,137,0.15);
  ...
  .p2-access-on { border-color:rgba(51,160,137,0.225); background:rgba(51,160,137,0.06);
    box-shadow:0 0 16px rgba(51,160,137,0.2); }
